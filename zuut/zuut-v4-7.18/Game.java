...
public class Game
{
     ...
     * @method printHelp()
     */
    private void printHelp(final Command pAppelCommandWorlds) {
        System.out.println("You are lost. You are alone.\nYou wander around at the ship. \n");
        System.out.println("Your command words are:");
        
        String[] vCommands = this.aParser.getShowCommands(); //création d'une variable locale pour stocker toutes les commands de getShowCommands() de type Parser
