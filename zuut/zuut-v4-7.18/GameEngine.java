...
public class GameEngine
{
    ...
    private void createRooms() {
        ...
        vMainEngine = new Room("in main engine room", "");
        
        // Left and Right room
        vRightWing = new Room("in right wing ", "");
        vLeftWing = new Room("in left wing", "");
        vRightEngine = new Room("in right engine", "");
        vLeftEngine = new Room("in left engine", "");
        
        // Wing Corridor
        vCorridorRightWing = new Room("in corridor right wing", "");
        vCorridorLeftWing = new Room("in corridor left wing","");
        
        // Corridor Wing Main to Engine Main
        vCorridorMainWingMainEngine = new Room("in corridor between main wing and main engine", "");
        
        //Engine Corridor
        vCorridorRightEngine = new Room("in corridor right engine", "");
        vCorridorLeftEngine = new Room("in corridor left engine", "");
        
        //Hidden Corridor
        vCorridorHiddenRight = new Room("in hidden corridor right between right wing and right engine", "");
        vCorridorHiddenLeft = new Room("in hidden corridor left between left wing and left engine", "");
