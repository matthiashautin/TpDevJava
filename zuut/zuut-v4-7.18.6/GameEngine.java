...
public class GameEngine
{
    ...
    private void createRooms() {
        ...
        //Main :
        vMainPilot = new Room("in main pilot room", vLienImages + "mainpilot.jpg");
        ...
        // Left and Right room
        vRightWing = new Room("in right wing ", vLienImages + "rightroomwing.jpg");
        vLeftWing = new Room("in left wing", vLienImages + "leftroomwing.png");
        vRightEngine = new Room("in right engine", vLienImages + "rightroomengine.jpg");
        vLeftEngine = new Room("in left engine", vLienImages + "leftroomengine.jpg");
