...
public class UserInterface implements ActionListener
{
    ...
    private JButton    aBtnActiveAudio;
    ...
    private void createGUI()
    {
        ...
        vListScroller.setPreferredSize( new Dimension(250, 250) );
        vListScroller.setMinimumSize( new Dimension(100,100) );
        
        //JButton
        this.aBtnActiveAudio = new JButton("Active Audio");
        this.aBtnActiveAudio.setPreferredSize(new Dimension(150,100));
        ...
        vPanel.add( this.aBtnActiveAudio, BorderLayout.EAST);//le placer à l'est
        ...
        this.aBtnActiveAudio.addActionListener(new ActionListener() {
            @Override
