...
public class Maison
{
    ...
    /**
     * donne la position d'un soleil, on récupere cette fonction dans getPositionsDeuxSoleils
     ...
     * @see fonction #getPositionSoleil(Cercle pCercle, return x + y)
     */
    /* Exercice 3.1.5a
    ...
    */ 
     ...
     * @see fonction #getPositionSoleil(Cercle pCercle, String pNomSoleil, return String pnomSoleil + x + y)
     */
    // Exercice 3.1.5.b   
    ...
    /**
     * return la position des Deux Soleils 
     * @param variables locales vPositionSoleil et vPositionSoleil1 permettent de récuperer la position X et Y des deux soleils et les stockes en mémoire
     * @return donne la position X et Y des deux soleils
     * @see fonction #getPositionsDeuxSoleils( return vPositionSoleil et vPositionSoleil1)
     */
