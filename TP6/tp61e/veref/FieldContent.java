...
//     public        String           toString()
    ...
    public String fieldType()
    {
        return this.aField.getType().getSimpleName();
    } // fieldType()

    public String fieldGType()
    {
        String vSimpleType = this.fieldType();
        String vLongType = this.aField.getGenericType().getTypeName();
        return vLongType.substring(vLongType.indexOf(vSimpleType));
    } // fieldType()
